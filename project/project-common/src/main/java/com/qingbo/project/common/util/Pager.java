...
/**
 * 分页实体，分页大小可以从表单hidden传入，也可以在Controller里设定。
 * <pre><code>
...
public class Pager implements Serializable {
	...
	private int pageWindow = 10;//页码窗口
	...
	public int getStartPage() {
		...
		return currentPage <= pageMiddle ? 1 : currentPage - pageMiddle;
	}
	
	public int getEndPage() {
		int endPage = getStartPage() + pageWindow;
